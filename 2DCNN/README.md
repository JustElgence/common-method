...
python -m visdom.server
python main.py --model SVM_grid --dataset PaviaU --training_sample 0.01
python main.py --model 2dcnn --dataset PaviaU --training_sample 0.01 --patch_size 21 --epoch 100

python main.py --model 2dcnn_deform_epf --dataset PaviaU --training_sample 0.01 --patch_size 21 --epoch 100
python main.py --model dbda --dataset PaviaU --training_sample 0.01 --patch_size 21 --epoch 100
python main.py --model hamida --dataset PaviaU --training_sample 0.01 --patch_size 21 --epoch 100

python main.py --model DeformNet_Regular_deform --dataset PaviaU --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model DeformNet_Regular_deform --dataset PaviaU --training_sample 0.0155 --patch_size 21 --epoch 200


python main.py --model 2dcnn --dataset Salinas --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model 2dcnn_deform_epf --dataset Salinas --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model DeformNet_Regular_deform --dataset Salinas --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model hamida --dataset Salinas --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model SVM_grid --dataset Salinas --training_sample 0.01


python main.py --model DeformNet_Regular_deform --dataset IndianPines --training_sample 0.01 --patch_size 21 --epoch 200


python main.py --model 2dcnn --dataset IndianPines --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model DeformNet_Regular_deform --dataset IndianPines --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model 2dcnn_deform_epf --dataset IndianPines --training_sample 0.01 --patch_size 21 --epoch 200



python main.py --model 2dcnn --dataset houston2013 --training_sample 0.01 --patch_size 21 --epoch 200

python main.py --model 2dcnn_deform_epf --dataset houston2013 --training_sample 0.01 --patch_size 21 --epoch 200

python main.py --model SVM_grid --dataset houston2013 --training_sample 0.01

python main.py --model 2dcnn --dataset houston2013 --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model hamida --dataset houston2013 --training_sample 0.01 --patch_size 21 --epoch 200
python main.py --model DeformNet_Regular_deform --dataset houston2013 --training_sample 0.01 --patch_size 21 --epoch 200