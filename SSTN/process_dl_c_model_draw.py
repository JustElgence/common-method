...
import visdom
from process_dl import convert_to_color_, convert_to_color
...
data_set_name_list = ['IP', 'PaviaU', "Salinas", "PaviaC","houston2013"]
data_set_name = data_set_name_list[1]
data_set_name = 'houston2013'
...
num_list = [10, 5]  # [train_num,val_num]
...
if __name__ == '__main__':
    ...
    display_predictions(convert_to_color(matrix, class_count + 1, palette = None), viz, caption="prediction")
