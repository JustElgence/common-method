...
def load_data(data_set_name, data_path):
    folder = '/home/t1/DL_Code/DATASET/' + data_set_name + '/'
    if data_set_name == 'IP':
        ...
        data = sio.loadmat(os.path.join(folder, 'PaviaU.mat'))['paviaU']
        labels = sio.loadmat(os.path.join(folder, 'PaviaU_gt.mat'))['paviaU_gt']
    elif data_set_name == 'Salinas':
        data = sio.loadmat(os.path.join(folder, 'Salinas_corrected.mat'))['salinas_corrected']
        labels = sio.loadmat(os.path.join(folder, 'Salinas_gt.mat'))['salinas_gt']
    elif data_set_name == 'PaviaC':
        img = sio.loadmat(os.path.join(folder, 'Pavia.mat'))
        data = img['pavia']
        labels = sio.loadmat(os.path.join(folder, 'Pavia_gt.mat'))['pavia_gt']
