...
class AMS_M2ESL(nn.Module):
    def __init__(self, in_channels, patch_size, class_count, ds_name):
        ...
        elif self.ds == 'Salinas':
            self.fc_0 = nn.Linear(7688, 512)
        elif self.ds == 'PaviaC':
            self.fc_0 = nn.Linear(1922, 512)
        elif self.ds == 'WHU-Hi-LongKou':
            self.fc_0 = nn.Linear(13122, 512)
        elif self.ds == 'KSC':
            self.fc_0 = nn.Linear(5618, 512)
        elif self.ds == 'Botswana':
            self.fc_0 = nn.Linear(3872, 512)
