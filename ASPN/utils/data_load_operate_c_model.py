...
def load_data(data_set_name, data_path):
    if data_set_name == 'IP':
        ...
        # data = sio.loadmat(os.path.join('/home/t1/DL_Code/DATASET/', "add_fog_dataset.mat"))['Iw']
        data = sio.loadmat(os.path.join('/home/t1/DL_Code/DATASET/' + 'PaviaU', 'PaviaU.mat'))['paviaU']
        labels = sio.loadmat(os.path.join('/home/t1/DL_Code/DATASET/' + 'PaviaU', 'PaviaU_gt.mat'))['paviaU_gt']
    elif data_set_name == 'Salinas':
        data = sio.loadmat(os.path.join('/home/t1/DL_Code/DATASET/' + 'Salinas', 'Salinas_corrected.mat'))['salinas_corrected']
        labels = sio.loadmat(os.path.join('/home/t1/DL_Code/DATASET/' + 'Salinas', 'Salinas_gt.mat'))['salinas_gt']
    elif data_set_name == 'PaviaC':
        img = sio.loadmat(os.path.join('/home/t1/DL_Code/DATASET/' + 'PaviaC', 'Pavia.mat'))
        data = img['pavia']
        labels = sio.loadmat(os.path.join('/home/t1/DL_Code/DATASET/' + 'PaviaC', 'Pavia_gt.mat'))['pavia_gt']
    ...
    elif data_set_name == 'houston2013':
