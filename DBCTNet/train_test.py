...
parser.add_argument('--n_run',type=int, default=5,help='times to run')
...
def load_data(dataset):
    ...
    if dataset == 'IP':
        data = sio.loadmat('/home/t1/DL_Code/DATASET/IndianPines/Indian_pines_corrected.mat')['indian_pines_corrected']
        labels = sio.loadmat('/home/t1/DL_Code/DATASET/IndianPines/Indian_pines.mat')['indian_pines_gt']
    else:
